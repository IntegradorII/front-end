...
export function DiscountCard ({ discount }: DiscountCardProps) {
  return (
    <article className="flex items-center justify-start h-[10rem] w-full gap-4 py-2 px-4 rounded-md bg-white cursor-pointer hover:shadow-sm">
      ...
      <span className="h-full w-[1px] bg-gray-900" />
