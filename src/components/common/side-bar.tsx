...
const SideBar = () => {
  ...
  return (
    <div className='w-[25%] min-w-[17rem] max-w-[18rem] first-letter:flex items-center justify-end'>
      <div className='w-full min-w-[16rem] h-full flex justify-start items-center py-7'>
        <div className="w-[16rem] flex flex-col items-center gap-3 bg-white px-6 py-6 rounded-3xl text-sm">
          ...
          <div className='flex flex-col items-center text-center bg-medium-gray rounded-xl font-semibold text-white px-6 py-1'>
            <p>
